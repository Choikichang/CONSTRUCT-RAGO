...
# 학습 데이터 샘플 출력
train_samples = load_kor_nli_samples('/home/choi/Git/ConSRoBERTa/data/ConNLI/ConNLI_train.tsv')
for sample in train_samples[:5]:
    print(f"Texts: {sample.texts}, Label: {sample.label}")

train_samples = load_kor_sts_samples('/home/choi/Git/ConSRoBERTa/data/ConSTS/ConSTS_train.tsv')
for sample in train_samples[:5]:
    print(f"Texts: {sample.texts}, Label: {sample.label}")