...
def main(input_folder):
    for filename in os.listdir(input_folder):
        if filename.endswith('.hwp'):
            ...
            txt_path = os.path.join("/data/data/Korea_construction_standard/txt", txt_name)
            convert_hwp_to_txt(hwp_path, txt_path)
            print(f"Converted {hwp_path} to {txt_path}")

if __name__ == "__main__":
    folders = ["/data/data/Korea_construction_standard/design", "/data/data/Korea_construction_standard/sibang"]
